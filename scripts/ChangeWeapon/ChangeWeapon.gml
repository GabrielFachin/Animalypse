...
self_recoil_push = wp_map[? "self_recoil_push"]
...
Projectiles_amount = wp_map[? "Projectiles_amount"]
tot_piercing = wp_map[? "Tot_piercing"]
projectile_size = wp_map[? "projectile_size"]
