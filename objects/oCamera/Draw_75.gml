...
draw_text_transformed(610,40,"Foccused Shots: " + string(oWeapon.Focused_Shots),0.5,0.5,0)

draw_text_transformed(610,50,"Ammo: " + string(oWeapon.ammo),0.5,0.5,0)

draw_text_transformed(610,60,"Wave: " + string(oEnemySpawner.current_wave),0.5,0.5,0)

draw_text_transformed(610,70,"Remaining: " + string(oEnemySpawner.current_wave_enemies),0.5,0.5,0)

draw_text_transformed(610,80,"Time: " + string(global.time),0.5,0.5,0)
...
draw_text_transformed(610,130,"Minions: " + string(global.minions),0.5,0.5,0)
