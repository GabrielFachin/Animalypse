...
void main()
{
	...
	// brilho minimo dos pixels pra refletir a lua:
	...
	// output:
	gl_FragColor	= vec4(out_col, 1.0); //com overlay
	//gl_FragColor	= vec4(out_col * col, 1.0); //sem overlay
}